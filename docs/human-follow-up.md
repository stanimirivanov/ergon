...
cursor value returns `400 invalid-human-follow-up-page`.
...
tenant contains work. The inbox is a shared discovery view, not a named queue,
and it provides no total count.
